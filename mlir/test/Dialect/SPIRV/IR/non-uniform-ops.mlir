...
func.func @group_non_uniform_bitwise_and(%val: i1) -> i1 {
  // expected-error @+1 {{op operand #0 must be 8/16/32/64-bit integer or fixed-length vector of 8/16/32/64-bit integer values of length 2-4294967295, but got 'i1'}}
...
func.func @group_non_uniform_logical_and(%val: i32) -> i32 {
  // expected-error @+1 {{op operand #0 must be bool or fixed-length vector of bool values of length 2-4294967295, but got 'i32'}}
